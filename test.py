...
def cvloop(run_event):
    ...
    while run_event.is_set():
        ...
        for face in faces:
            ...
            if SPRITES[3]:  # Tiara
                apply_sprite(
                    image, IMAGES[3][ACTIVE_IMAGES[3]], w+50, x-20, y+10, incl)
            ...
            if SPRITES[2]:
                ...
                apply_sprite(
                    image, IMAGES[2][ACTIVE_IMAGES[2]], w3, x3-33, y3+35, incl, ontop=False)
...
#                apply_sprite(image, IMAGES[5][ACTIVE_IMAGES[5]],w,x,y, incl, ontop = True)
            ...
            if SPRITES[4]:
                ...
                apply_sprite(
                    image, IMAGES[4][ACTIVE_IMAGES[4]], w1+600, x1-370, y1+80, incl,  ontop=False)
